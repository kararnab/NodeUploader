const uploadFiles = (() => {
    ...
    const ENDPOINTS = {
        UPLOAD: `${baseUrl}/multi-upload`,
        UPLOAD_STATUS: `${baseUrl}/upload-status`,
        UPLOAD_REQUEST: `${baseUrl}/upload-request`
    }
...
const uploadAndTrackFiles = (() => {
    ...
    return (uploadedFiles) => {
        ...
        document.getElementById('multiFileUpload').appendChild(progressBox);
